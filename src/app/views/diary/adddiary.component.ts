...
export class AddDiaryComponent implements OnInit {
    ...
    onSubmit() {
        ...
        this.assignDiaryAddParams();
        console.log("parms====" + JSON.stringify(this.addDiary));
        this.addDiaryApi();
    }
    ...
    private assignDiaryAddParams() {
        ...
        this.addDiary.message = this.ckeditorContent;
        this.addDiary.fromUserId = this.userData.userId;
        this.addDiary.sentTypeId = this.sendTypeId;
        this.addDiary.content = this.crypto.encryptByAES(this.uploadFileName);
        this.addDiary.contentType = this.contentType;
        this.addDiary.toId = this.sendToDOId;
        this.addDiary.userTypeList = this.sendUserTypeList;
    ...
    addDiaryApi():void {
        this.insmanagerService.addDairyWithPromise(this.addDiary)
            .then(diaryAddData => {
                console.log("diaryAddData======================" + JSON.stringify(diaryAddData));
                var data = JSON.parse(JSON.stringify(diaryAddData));
                if (data.status.success) {
                    this.toastr.success('', "Dairy message added successfully! ");
                } else {
                    this.toastr.error('', data.status.description);
